...
/*
Package app_serverpb is a reverse proxy.
...
func local_request_PokemonService_GetPokemon_0(ctx context.Context, marshaler runtime.Marshaler, server PokemonServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq PokemonRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetPokemon(ctx, &protoReq)
	return msg, metadata, err
...
// Note that using this registration option will cause many gRPC library features (such as grpc.SendHeader, etc) to stop working. Consider using RegisterPokemonServiceHandlerFromEndpoint instead.
func RegisterPokemonServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PokemonServiceServer) error {

	mux.Handle("POST", pattern_PokemonService_GetPokemon_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PokemonService_GetPokemon_0(rctx, inboundMarshaler, server, req, pathParams)
