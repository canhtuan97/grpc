...
type PokemonResponse struct {
	...
	Height         int64  `protobuf:"varint,4,opt,name=Height,json=height,proto3" json:"Height,omitempty"`
}
...
func (x *PokemonResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PokemonResponse) GetBaseExperience() int64 {
	if x != nil {
...
func (x *PokemonResponse) GetHeight() int64 {
	if x != nil {
		return x.Height
	}
	return 0
...
var file_proto_app_server_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x62, 0x61, 0x73, 0x65, 0x45, 0x78,
