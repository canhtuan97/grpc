...
func request_YourService_Echo_0(ctx context.Context, marshaler runtime.Marshaler, client main.YourServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq main.StringMessage
...
func local_request_YourService_Echo_0(ctx context.Context, marshaler runtime.Marshaler, server main.YourServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq main.StringMessage
	var metadata runtime.ServerMetadata
...
func RegisterYourServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server main.YourServiceServer) error {
...
func RegisterYourServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client main.YourServiceClient) error {
